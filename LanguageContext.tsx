...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    officialWinner: "Pemenang Sah",
    screenshotInstruction: "UNDUH BUKTI KLAIM (E-TICKET)",
...
Melalui jaringan afiliasi, GUCCI ingin memastikan bahwa image sebagai brand luxury tetap kuat, modern, dan relevan dengan perubahan zaman—baik dalam konteks fashion, teknologi, maupun gaya hidup global.`,
  ...
  en: {
    ...
    screenshotInstruction: "DOWNLOAD CLAIM PROOF (E-TICKET)",
    welcomeTitle: "Holiday Wishes 2025-2026",
  ...
  zh: {
    ...
    validUntil: "有效期至",
    claimReward: "查看电子票",
    officialWinner: "正式获奖者",
    screenshotInstruction: "下载索赔凭证 (E-TICKET)",
  ...
  es: {
    ...
    claimReward: "Ver Boleto",
    officialWinner: "Ganador Oficial",
    screenshotInstruction: "DESCARGAR COMPROBANTE (E-TICKET)",
  ...
  hi: {
    ...
    menu: "दृष्टि और मिशन",
    validUntil: "तक मान्य",
    claimReward: "टिकट देखें",
    officialWinner: "आधिकारिक विजेता",
    screenshotInstruction: "दावा प्रमाण डाउनलोड करें (ई-टिकट)",
  ...
  ar: {
    ...
    validUntil: "صالح حتى",
    claimReward: "عرض التذكرة",
    officialWinner: "الفائز الرسمي",
    screenshotInstruction: "تحميل إثبات المطالبة (التذكرة الإلكترونية)",
  ...
  pt: {
    ...
    claimReward: "Ver Bilhete",
    officialWinner: "Vencedor Oficial",
    screenshotInstruction: "BAIXAR COMPROVANTE (E-TICKET)",
  ...
  ru: {
    ...
    claimReward: "Посмотреть билет",
    officialWinner: "Официальный победитель",
    screenshotInstruction: "СКАЧАТЬ ПОДТВЕРЖДЕНИЕ (ЭЛЕКТРОННЫЙ БИЛЕТ)",
  ...
  ja: {
    ...
    screenshotInstruction: "請求証明書をダウンロード (E-TICKET)",
  ...
  de: {
    ...
    claimReward: "Ticket ansehen",
    officialWinner: "Offizieller Gewinner",
    screenshotInstruction: "ANSPRUCHSNACHWEIS HERUNTERLADEN (E-TICKET)",
  ...
  fr: {
    ...
    claimReward: "Voir le Billet",
    officialWinner: "Gagnant Officiel",
    screenshotInstruction: "TÉLÉCHARGER LA PREUVE DE RÉCLAMATION (E-TICKET)",
  ...
  it: {
    ...
    claimReward: "Vedi Biglietto",
    officialWinner: "Vincitore Ufficiale",
    screenshotInstruction: "SCARICA PROVA DI RECLAMO (E-TICKET)",
  ...
  ko: {
    ...
    validUntil: "유효 기간",
    claimReward: "티켓 보기",
    officialWinner: "공식 우승자",
    screenshotInstruction: "청구 증명 다운로드 (E-TICKET)",
