...
const translations: Record<Language, Record<string, string>> = {
  ...
  ja: {
    ...
    welcomeText: "無限のラグジュアリーと共に2026年の夜明けを迎えましょう。今夜の祝賀の輝きの下で、あなただけの限定ゴールデンスクラッチのサプライズを見つけてください。",
    ...
    voucherPrefix: "バウチャー",
    discountPrefix: "輝き",
    claimMessage: "こんにちは、Gucci Indonesiaから新年の特典を獲得しました",
    codeLabel: "ラッキーコード",
  ...
  ko: {
    ...
    welcomeText: "무한한 럭셔리와 함께 2026년의 새벽을 맞이하세요. 오늘 밤 축제의 불꽃 아래에서 당신만의 독점적인 골든 스크래치 서프라이즈를 발견하세요.",
  ...
  es: {
    ...
    welcomeText: "Reciba el amanecer de 2026 con un lujo sin límites. Descubra su sorpresa exclusiva Golden Scratch bajo el brillo festivo de esta noche.",
  ...
  ar: {
    ...
    welcomeText: "استقبل فجر عام ٢٠٢٦ برفاهية لا حدود لها. اكتشف مفاجأة جولدن سكراتش الحصرية تحت بريق احتفالات الليلة.",
